[![Tests](https://github.com/mutantsan/ckanext-harvest-basket/workflows/Tests/badge.svg?branch=main)](https://github.com/mutantsan/ckanext-harvest-basket/actions)
...
3. Add `harvest-basket` to the `ckan.plugins` setting in your CKAN
